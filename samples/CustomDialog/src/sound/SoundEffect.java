...
public enum SoundEffect {
    ...
    EXPLODE("bg1.wav"), // explosion
    GONG("bg2.wav"), // gong
    SHOOT("bg1.wav");       // bullet
    ...
    public void play() {
        System.out.println(EXPLODE.clip.isRunning());
        System.out.println(GONG.clip.isRunning());
        System.out.println(SHOOT.clip.isRunning());

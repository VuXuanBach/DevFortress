...
/**
 *
 * <p> All properties in this class are bound: when a properties value is
 * changed, all PropertyChangeListeners are fired.
 *
 * @author Hans Muller
 */
public class MultiSplitPane extends JPanel {
     ...
     * <code>continuousLayout</code> property. If true, then the layout is
     * revalidated continuously while a divider is being moved. The default
     ...
     *
     * @param dividerPainter the value of the dividerPainter property, can be
     * null
     * @see #paintChildren
     * @see #activeDivider
     */
     ...
     * <code>super.paintChildren()</code> so that Dividers can be rendered "on
    ...
    private org.jdesktop.swingx.MultiSplitLayout.Divider dragDivider = null;
    ...
    private void startDrag(int mx, int my) {
        ...
        org.jdesktop.swingx.MultiSplitLayout msl = getMultiSplitLayout();
        org.jdesktop.swingx.MultiSplitLayout.Divider divider = msl.dividerAt(mx, my);
        if (divider != null) {
            org.jdesktop.swingx.MultiSplitLayout.Node prevNode = divider.previousSibling();
            org.jdesktop.swingx.MultiSplitLayout.Node nextNode = divider.nextSibling();
    ...
    private void updateCursor(int x, int y, boolean show) {
        ...
        if (show) {
            org.jdesktop.swingx.MultiSplitLayout.Divider divider = getMultiSplitLayout().dividerAt(x, y);
            if (divider != null) {
